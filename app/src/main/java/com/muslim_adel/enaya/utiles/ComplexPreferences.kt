...
class ComplexPreferences @SuppressLint("CommitPrefEdits") constructor(context: Context, namePreferences: String?, mode: Int) {
   ...
   // fun isAppEnglish(): Boolean = getInteger(com.muslim_adel.enaya.utiles.Q.SELECTED_LOCALE_PREF, com.muslim_adel.enaya.utiles.Q.LOCALE_AR_INDEX) == com.muslim_adel.enaya.utiles.Q.LOCALE_EN_INDEX
