package com.muslim_adel.enaya.modules.appointments.fragments
...
import kotlinx.android.synthetic.main.fragment_my_offers_fragments.*
...
class MyOffersFragments : Fragment() {
    ...
    private fun appointmentsObserver() {
        ...
        onObserveStart()
        apiClient.getApiService(mContext!!).fitchOffersBookingList()
    ...
    private fun initRVAdapter() {
        ...
        appointmentsAddapter = AppointmentsAdapter(mContext!!,appointmentsList,true)
