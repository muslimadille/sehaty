...
import com.muslim_adel.enaya.modules.offers.OfferDetailsActivity
import kotlinx.android.synthetic.main.rate_item.view.*


class LabRatesAdapter(
    private val mContext: LabDetailsActivity,
    private val list: MutableList<Rates>) : RecyclerView.Adapter<LabRatesAdapter.ViewHolder>() {
