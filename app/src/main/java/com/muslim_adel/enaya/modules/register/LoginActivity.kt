...
import com.muslim_adel.enaya.data.remote.apiServices.ApiClientnew
...
import com.muslim_adel.enaya.modules.register.resetpassword.AddPhoneActivity
...
import com.muslim_adel.enaya.modules.register.RegisterationActivity
                ...
                .enqueue(object : Callback<GenerateToken> {
                    ...
                    override fun onResponse(
                        ...
                        if (loginResponse!!.isSuccessful && loginResponse.body()!!.access_token != null) {
                            ...
                            // preferences!!.putBoolean(com.muslim_adel.enaya.utiles.Q.IS_FIRST_TIME,false)
                            // preferences!!.putBoolean(com.muslim_adel.enaya.utiles.Q.IS_LOGIN,true)
                            // preferences!!.putInteger(com.muslim_adel.enaya.utiles.Q.USER_ID,registerResponse.data!!.user.id.toInt())
                            // preferences!!.putString(com.muslim_adel.enaya.utiles.Q.USER_NAME,registerResponse.data!!.user.name)
                            //preferences!!.putString(com.muslim_adel.enaya.utiles.Q.USER_EMAIL,registerResponse.data!!.user.email)
                            // preferences!!.putString(com.muslim_adel.enaya.utiles.Q.USER_PHONE,registerResponse.data!!.user.phonenumber.toString())
                            // preferences!!.putInteger(com.muslim_adel.enaya.utiles.Q.USER_GENDER,registerResponse.data!!.user.gender_id)
                            // preferences!!.putString(com.muslim_adel.enaya.utiles.Q.USER_BIRTH,registerResponse.data!!.user.birthday)
                            //  preferences!!.commit()
                            onObserveSuccess()
                            socialLoginObserver()
                            /*val intent =
